...
{
    public partial class NWConsole_48_BMBContext : DbContext
    {
        public NWConsole_48_BMBContext()
        {
        }

        public NWConsole_48_BMBContext(DbContextOptions<NWConsole_48_BMBContext> options)
            : base(options)
        {
        }
